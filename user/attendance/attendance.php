...
if(isset($_SESSION['user_id']) && isset($_SESSION['user_icC'])){
    ...
    if($user_data ===  false){
        header('Location: ../../user/logoutC.php');
        exit;
    }
...
{
	$user = $_GET['user'];
	$get_user = $conn->query("SELECT * from coach WHERE coach_id ='$user'");
        ...
        <section class="home_banner_area">
           	<div class="container box_1620">
           		<div class="banner_inner d-flex align-items-center">
					...
					<form method="post" action="attendance-action.php?user=<?php echo $user_data->coach_id?>" enctype="multipart/form-data">
	
						 <h2>Please drop attendance file here</h2>
			...
			<h2>Date: <input type="date" name="attendance_date"  class="form-control" required></h2>
			
			<br>
			
            <h2>Files <span style="color:red">*</span><input type="file" name="attendance_file" required></h2>
			...
			<input type="submit" name="upload" value"upload attendance" />

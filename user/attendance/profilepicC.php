...
<body>
	...
	<form method="post" class="form-horizontal" action="profilepicC-action.php?user=<?php echo $user_data->coach_id ?>" enctype="multipart/form-data">
		<div class="form-group">
		
<div class="col-sm-8">
	<img src="<?php echo $user_data->coach_pic; ?>" width="300" height="200" style="border:solid 1px #000">
		</div>
		...
		<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="hidden" name="oldimage" value"<?= $user_data->coach_pic; ?>">
	...
	<div class="col-sm-8 col-sm-offset-4">
								<a href="editcoach-pic.php"  class="button button4">Back</a>

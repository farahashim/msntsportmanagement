...
include ("config.php");
  ...
  if(isset($_POST['tambah'])){
    ...
    $app_sql = "SELECT booking_id FROM booking_facility WHERE coach_id = '$coach' AND booking_status = '$status'";
  ...
  if($app == 0){
            ...
            $sql = "INSERT INTO booking_facility (facility_id, coach_id, booking_start, booking_end, booking_status)
            VALUES('$id','$coach','$mula','$tamat', '$status')";
  ...
  <body>
    ...
    <nav class="nav">
          ...
          <ul class="nav__list" role="menubar">
            <li class="nav__item ">
                <a href="/sukan/user/equipment/crud.php"
                     >
              ...
              <li class="nav__item nav__item--isActive"><a href="/sukan/user/facility/crud.php" class="nav__link focus--box-shadow"
                     role="menuitem"
    ...
    <main class="main">
          ...
          <?php } ?>
            <header class="section__header">
              <h2 class="section__title">Senarai Tempahan Fasiliti</h2>
            ...
            <ul class="project">
                ...
                <h4>Tempah Fasiliti</h4>
                <form class="gform_wrapper" onsubmit="successBox()" method="POST" action="">
                    <span>
                    <select class="input--style-3" type="text" name="facility_id" style="color: rgba(255, 255, 255, 0.7) !important;"required>
                        <option value="" style="color: rgba(255, 255, 255, 0.7) !important;">Pilih Fasiliti</option>
                          <?php 
                                $facility_q = "SELECT * FROM facility";
                                $result_p = mysqli_query($link, $facility_q);
            ...
            ?>
              ...
              <table class="data">
                ...
                $total_pages_sql = "SELECT COUNT(booking_id) FROM booking_facility";
                $result = mysqli_query($link, $total_pages_sql);
                $total_rows = mysqli_fetch_array($result)[0];
                
                $total_pages  =ceil($total_rows / $no_of_records_per_page);

                $sql = "SELECT * FROM booking_facility b JOIN facility s ON s.facility_id = b.facility_id LIMIT $offset, $no_of_records_per_page";

...
if(isset($_POST['user_icA'])&& isset($_POST['user_password']))
{
	$result = $user_obj->loginUser($_POST['user_icA'],$_POST['user_password']);
	
}
	//ni dh login
	if(isset($_SESSION['user_icA']))
	{
		header('Location: atletprofile.php');
		exit;
}
	 ...
	 <form method="POST" action="">
            <h2 class="title">Sign In</h2>
              <div class="input-group">
                  <input class="input--style-3" type="text" id="user_icA" name="user_icA" placeholder="Identity Card" spellcheck="false" required autofocus>
              </div>
              <div class="input-group">
      ...
      ?>    
				  ...
				  <a href="sport_signup.php" class="btn btn--pill btn--green">Register</a>

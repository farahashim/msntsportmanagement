...
{
	$user = $_GET['user'];
	$get_user = $conn->query("SELECT * from atlet WHERE atlet_ic ='$user'");
...
<head>
<meta charset="utf-8">
<title><?php echo  $user_data->atlet_FN;?></title>
...
<body>
	...
	<div class="col-sm-3">
		...
		Profile Picture <img src="<?php echo $user_data->atlet_pic; ?>" width="300" height="200" style="border:solid 1px #000">
		<a href="profilepicA.php?imgid=<?php echo $user_data->atlet_id ?>">Change Profile Picture</a>

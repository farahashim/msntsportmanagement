<?php
	...
	if(isset($_POST['add'])){
	   ...
	   $hash = password_hash($coach_pass, PASSWORD_DEFAULT);
		...
		$stmt->bind_param("ssssssssssssssssss",$coach_ic,$coach_FN,$coach_LN,$coach_age,$coach_email,$coach_address,$coach_postcode,$coach_phonenum,$hash,$coach_status,$coach_gender,$coach_nation,$coach_religion,$coach_stateofbirth,$coach_dob,$coach_sport,$upload,$coach_schedule);
		$stmt->execute();

...
session_start();
  ...
  if (isset($_GET['booking_id'])) {
    ...
    if($_GET['button'] == 'accept'){
      $sql = "UPDATE booking_vehicle SET booking_status = 'Accepted' WHERE booking_id = '$id'";
      $query = mysqli_query($link, $sql);
      $success_msg= "Tempahan bagi id tempahan ".$id." telah diluluskan!";
    }
    else{
      $sql = "UPDATE booking_vehicle SET booking_status = 'Rejected' WHERE booking_id = '$id'";
      $query = mysqli_query($link, $sql);
  ...
  <body>
    ...
    <nav class="nav">
          ...
          <ul class="nav__list" role="menubar">
            <li class="nav__item ">
                <a href="../../admin/equipment/crud2.php">
          ...
          <?php } ?>
            ...
            ?>
              ...
              <table class="data">
                ...
                $total_pages_sql = "SELECT COUNT(booking_id) FROM booking_vehicle";

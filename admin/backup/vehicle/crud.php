    ...
    <nav class="nav">
          ...
          <ul class="nav__list" role="menubar">
            <li class="nav__item ">
              ...
              <li class="nav__item"><a href="../../admin/facility/crud.php"><img src="styleAdm/ico/add-fc.svg" width="40"></a></li>
          </ul>
          <!--menu bar end-->
      </nav>
    <main class="main">
          ...
          <section class="section">
            <header class="section__header">
              <h2 class="section__title">Senarai Pengangkutan</h2>
            ...
            <ul class="project">
                ...
                <h4>Tambah Pengangkutan</h4>
                <form class="gform_wrapper" onsubmit="successBox()" method="POST" action="create.php">
                    <span>
                        <input class="input--style-3" type="text" placeholder="Nombor Pendaftaran" name="vehicle_noplate" required>
                    </span>
                    <span>
                    <span>
                        <select class="input--style-3" type="text" name="vehicle_type" style="color: rgba(255, 255, 255, 0.7) !important;"required>
                          <option value="" style="color: rgba(255, 255, 255, 0.7) !important;">Pilih Jenis Kenderaan</option>
              ...
              <table class="data">
                ...
                <tr>
                  ...
                  <td>
                  <a href="update.php?vehicle_id=<?= $row['vehicle_id']; ?>"><button class="btn btn-warning btn-xs edit_data">Kemas Kini</button></a>
                  <a href="delete.php?vehicle_id=<?= $row['vehicle_id']; ?>"><button class="btn btn-danger btn-xs delete_data">Hapus</button></a>
                  </td>
                </tr>
                <?php } ?>
                </table>

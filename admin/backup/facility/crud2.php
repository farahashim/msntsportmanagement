...
session_start();
  ...
  if (isset($_GET['booking_id'])) {
    ...
    if($_GET['button'] == 'accept'){
      $sql = "UPDATE booking_facility SET booking_status = 'Accepted' WHERE booking_id = '$id'";
      $query = mysqli_query($link, $sql);
      $success_msg= "Tempahan bagi id tempahan ".$id." telah diluluskan!";
    }
    else{
      $sql = "UPDATE booking_facility SET booking_status = 'Rejected' WHERE booking_id = '$id'";
      $query = mysqli_query($link, $sql);

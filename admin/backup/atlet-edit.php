...
{
	$user = $_GET['user'];
	$get_user = $conn->query("SELECT * from atlet WHERE atlet_id ='$user'");
...
<head>
  <!-- Required meta tags -->
		...
		<link rel="icon" href="logokawan.png" type="image/x-icon">
       
        <title><?php echo  $user_data->atlet_FN;?><?php echo  $user_data->atlet_LN;?></title>
        <!-- Bootstrap CSS -->
					...
					<div class="container box_1620">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								<li class="nav-item active"><a class="nav-link" href="atletprofile.php">Home</a>
								</li> 
								 
								<li class="nav-item active"><a class="nav-link" href="atlet-edit.php">Edit Information</a>
								</li> 
							<li class="nav-item active"><a class="nav-link" href="editatlet-pic.php">Edit Pictures</a>
								</li>
							
							
								
								<li class="nav-item"><a class="nav-link" href="logoutA.php">LOGOUT</a></li>
							</ul>
						</div> 
					</div>
            	</nav>
        ...
        <section class="home_banner_area">
           	<div class="container box_1620">
           		<div class="banner_inner d-flex align-items-center">
					...
					<form method="post" action="editatlet-action.php?user=<?php echo $user_data->atlet_id?>" enctype="multipart/form-data">
	
						 <h2><?php echo  $user_data->atlet_FN;?> <?php echo  $user_data->atlet_LN;?>'s Details :</h2>
						
			
			
			<h2>
				<input type="hidden" name="id" value="<?=$user_data->atlet_id;?>">
			...
			<h2>Password: <input type="password" name="atlet_pass"  class="form-control"  placeholder="Enter new password" required></h2>
			
			<br>
			
            <h2>Phone Number: <input type="text" name="atlet_phonenum" value="<?= $user_data->atlet_phonenum; ?>" class="form-control"  placeholder="Phone Number" required></h2>
			
			<br>
						<h2>Phone Number Parent: <input type="text" name="atlet_phonenumpp" value="<?= $user_data->atlet_phonenumpp; ?>" class="form-control"  placeholder="Phone Number parent" required></h2>
           <br>
            
						<h2>Address : 
							<br>
							<textarea name="atlet_address" rows="4" cols="50"><?php echo $user_data->atlet_address; ?></textarea> </h2>
						<br>
						<h2>Postcode: <input type="number" name="atlet_postcode" value="<?= $user_data->atlet_postcode; ?>" class="form-control"  placeholder="postcode" required></h2>
						<br>

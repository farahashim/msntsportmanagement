...
<html lang="en">
    ...
    <body>
					...
					<div class="container box_1620">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item">
									<a class="nav-link" href="atlet-edit.php">Edit Information</a>
								</li>
					
								<li class="nav-item">
									<a class="nav-link" href="editatlet-pic.php">Edit picture</a>
								</li>
           	...
           	<div class="container box_1620">
           		<div class="banner_inner d-flex align-items-center">
					<div class="banner_content">
						<div class="media">
							<div class="d-flex">
								<img  src="<?php echo $user_data->atlet_pic; ?>" alt="" style="width:500px;height:600px;">
							</div>
							<div class="media-body">
								<div class="personal_text">
									<h6>Hello ! Welcome Back</h6>
									<h3><?php echo  $user_data->atlet_FN;?> <?php echo  $user_data->atlet_LN;?></h3>
									
									<h4><?php echo  $user_data->atlet_ic;?></h4>
									...
									<ul class="list basic_info">
										<li><a href="#"><i class="lnr lnr-dice"></i> <?php echo  $user_data->atlet_gender;?></a></li>
										<li><a href="#"><i class="lnr lnr-book"></i> <?php echo  $user_data->atlet_sport;?></a></li>
										<li><a href="#"><i class="lnr lnr-home"></i>  <?php echo  $user_data->atlet_age;?></a></li>
										<li><a href="#"><i class="lnr lnr-flag"></i> <?php echo  $user_data->atlet_stateofbirth;?></a></li>
										<li><a href="#"><i class="lnr lnr-phone-handset"></i>  <?php echo  $user_data->atlet_phonenum;?></a></li>
										
										<li><a href="#"><i class="lnr lnr-envelope"></i> <?php echo  $user_data->atlet_email;?></a></li>
		...
		<h4>Schedule</h4>
		<h3>
			<a href="atletprofile.php?file_id=<?php echo $user_data->atlet_id;?>">Download</a>
